...
PROJ_DIR=/home/jovyan/shares/SR006.nfs1/amaksimova/LLM-Shearing-main
LAUNCH_SCRIPT=/home/jovyan/shares/SR006.nfs1/amaksimova/LLM-Shearing-main/llmshearing/scripts/launch.sh
DATA_DIR=/home/jovyan/shares/SR006.nfs1/amaksimova/data/mds_cultura_tokenized_full/for_prune/
OUTPUT_DIR=/home/jovyan/shares/SR006.nfs1/amaksimova/LLM-Shearing-main/llmshearing/models
TRAIN_SCRIPT=${PROJ_DIR}/llmshearing/train.py
MODEL_PATH=/home/jovyan/shares/SR006.nfs1/amaksimova/models/GigaChat-2-Lite-128k-preview_mh/
export PYTHONPATH="/home/jovyan/shares/SR006.nfs1/amaksimova/LLM-Shearing-main:$PYTHONPATH" 
# Specify $PROJ_DIR in scripts/launch.sh and scripts/srun_launch.sh if using slurm

test=False

from_model=9b # source model size
to_model=1.3b # target model size
config_file=${PROJ_DIR}/llmshearing/configs/llama2/${from_model}.yaml
path=/home/jovyan/shares/SR006.nfs1/amaksimova/models/GigaChat-2-Lite-128k-preview_mh/state_dict3.pt
...
# learning setup
lr=5e-4 # learning rate for the main parameters
...
dynamic=True
set_names=[cultura_ru] # domain names
proportion=[1] # initial proportion of RP, make sure that the sum(proportion) = 1
# doremi: update weights with exponential descent
# constant: keep the weights constant
update_type=doremi 
if [[ $to_model == 1.3b ]]; then
    target_loss=[2.6] # 1.3b predicted loss from scaling law
...
# save directroy
run_name=llama2_${from_model}_pruning_scaling_${update_type}_to${to_model}_sl${max_seq_len}_lr${lr}_bs${device_train_microbatch_size}_latest
...
cd /home/jovyan/shares/SR006.nfs1/amaksimova/LLM-Shearing-main

composer /home/jovyan/shares/SR006.nfs1/amaksimova/LLM-Shearing-main/llmshearing/train.py \
    $config_file \
    run_name=${run_name} \
