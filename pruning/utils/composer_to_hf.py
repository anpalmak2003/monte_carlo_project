...
def construct_hf_config(model_config: om = None):
    ...
    if model_class == "LlamaForCausalLM":
        hf_model_name = "/home/jovyan/shares/SR006.nfs1/amaksimova/models/9b/GigaChat-2-Lite-128k-preview"
        tokenzier_name = "/home/jovyan/shares/SR006.nfs1/amaksimova/models/9b/GigaChat-2-Lite-128k-preview"
